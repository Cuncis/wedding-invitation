...
const headingFonts = [
    ...
    'Marcellus', 'Italiana', 'DM Serif Display', 'Lora',
];
const bodyFonts = [
            ...
            <div class="p-3 rounded-xl border-2 border-base-300 bg-base-100 space-y-2">
                ...
                <div class="relative">
                    <button type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-base-content/40 shrink-0 ml-2 transition-transform"
                            :class="{ 'rotate-180': headingOpen }"
