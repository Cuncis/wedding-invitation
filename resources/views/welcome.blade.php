...
<html lang="id">
    <head>
        ...
        <style>
            :root { --font-serif: 'Playfair Display', Georgia, serif; --font-sans: 'Inter', system-ui, sans-serif; }
    ...
    <body class="bg-white text-slate-800 antialiased">
        {{-- ===================== NAVBAR ===================== --}}
        <header class="fixed top-0 inset-x-0 z-50 bg-white/90 backdrop-blur-md border-b border-rose-100 shadow-sm">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <nav class="hidden md:flex items-center gap-7 text-sm font-medium text-slate-600">
                        <a href="#beranda" class="hover:text-rose-600 transition-colors">Beranda</a>
                        <a href="#fitur" class="hover:text-rose-600 transition-colors">Fitur</a>
                        <a href="#tema" class="hover:text-rose-600 transition-colors">Tema</a>
                        <a href="#harga" class="hover:text-rose-600 transition-colors">Harga</a>
                        <a href="#kontak" class="hover:text-rose-600 transition-colors">Kontak</a>
                    </nav>
                    ...
                    {{-- Mobile hamburger --}}
                    <button id="nav-toggle" class="md:hidden p-2 rounded-lg text-slate-600 hover:bg-rose-50">
            ...
            {{-- Mobile menu --}}
            <div id="mobile-menu" class="hidden md:hidden border-t border-rose-100 bg-white px-4 py-4 space-y-3">
                <a href="#beranda" class="block text-sm font-medium text-slate-600 hover:text-rose-600">Beranda</a>
                <a href="#fitur" class="block text-sm font-medium text-slate-600 hover:text-rose-600">Fitur</a>
                <a href="#tema" class="block text-sm font-medium text-slate-600 hover:text-rose-600">Tema</a>
                <a href="#harga" class="block text-sm font-medium text-slate-600 hover:text-rose-600">Harga</a>
                <a href="#kontak" class="block text-sm font-medium text-slate-600 hover:text-rose-600">Kontak</a>
        ...
        {{-- ===================== HERO ===================== --}}
        <section id="beranda" class="relative min-h-screen flex items-center bg-linear-to-br from-rose-50 via-white to-pink-50 overflow-hidden pt-16">
            {{-- Decorative blobs --}}
            <div class="absolute top-20 right-0 w-96 h-96 bg-rose-100 rounded-full mix-blend-multiply filter blur-3xl opacity-40 pointer-events-none"></div>
            <div class="absolute bottom-0 left-10 w-72 h-72 bg-pink-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 pointer-events-none"></div>

            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center">
                {{-- Text --}}
                <div>
                    <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-100 text-rose-700 text-xs font-semibold tracking-wide uppercase mb-6">
                        ✨ Undangan Digital Terbaik 2025
                    </span>
                    <h1 class="font-serif text-5xl lg:text-6xl font-bold text-slate-900 leading-tight mb-6">
                        Undangan Pernikahan<br>
                        <span class="text-rose-600 italic">yang Tak Terlupakan</span>
                    </h1>
                    ...
                    {{-- Stats --}}
                    <div class="flex gap-8 mt-10 pt-8 border-t border-rose-100">
                        <div>
                            <p class="font-serif text-3xl font-bold text-slate-900">500+</p>
                            <p class="text-sm text-slate-500 mt-0.5">Undangan Dibuat</p>
                        </div>
                        <div>
                            <p class="font-serif text-3xl font-bold text-slate-900">3</p>
                            <p class="text-sm text-slate-500 mt-0.5">Tema Elegan</p>
                        </div>
                        <div>
                            <p class="font-serif text-3xl font-bold text-slate-900">98%</p>
                            <p class="text-sm text-slate-500 mt-0.5">Kepuasan Klien</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="relative rounded-3xl overflow-hidden shadow-2xl shadow-rose-200">
                        {{-- Replace src with your real hero image --}}
                        <img src="https://placehold.co/600x700/fce7f3/9f1239?text=Preview+Undangan" alt="Contoh undangan digital" class="w-full object-cover">
                        {{-- Floating badge --}}
                        <div class="absolute top-6 left-6 bg-white rounded-2xl shadow-lg px-4 py-3 flex items-center gap-3">
                            <span class="text-2xl">💌</span>
                            <div>
                                <p class="text-xs text-slate-400">Baru dikirim</p>
                                <p class="text-sm font-semibold text-slate-800">Andi & Budi</p>
                            </div>
                        </div>
                        <div class="absolute bottom-6 right-6 bg-white rounded-2xl shadow-lg px-4 py-3">
                            <p class="text-xs text-slate-400">Tamu konfirmasi hadir</p>
                            <p class="text-xl font-bold text-rose-600">127 Tamu</p>
                        </div>
                    </div>
                    {{-- Decorative ring --}}
                    <div class="absolute -top-4 -right-4 w-full h-full border-2 border-rose-200 rounded-3xl -z-10"></div>
                </div>
            </div>
        </section>
        ...
        <section id="fitur" class="py-24 bg-white">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {{-- Feature 1 --}}
                    <div class="group p-7 rounded-2xl border border-slate-100 hover:border-rose-200 hover:shadow-lg hover:shadow-rose-50 transition-all">
                        ...
                        <h3 class="font-semibold text-slate-900 text-lg mb-2">Desain Elegan</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">3 tema premium dengan pilihan warna, font, dan tata letak yang sepenuhnya bisa dikustomisasi sesuai selera.</p>
                    </div>
                    ...
                    <div class="group p-7 rounded-2xl border border-slate-100 hover:border-rose-200 hover:shadow-lg hover:shadow-rose-50 transition-all">
                        ...
                        <h3 class="font-semibold text-slate-900 text-lg mb-2">RSVP Online</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Tamu konfirmasi kehadiran langsung dari undangan. Kamu dapat melihat daftar tamu secara real-time dan ekspor ke CSV.</p>
                    </div>
                    ...
                    <div class="group p-7 rounded-2xl border border-slate-100 hover:border-rose-200 hover:shadow-lg hover:shadow-rose-50 transition-all">
                        ...
                        <h3 class="font-semibold text-slate-900 text-lg mb-2">Notifikasi WhatsApp</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Notifikasi otomatis via WhatsApp saat ada RSVP baru, dan tamu menerima pesan ketika undangan aktif.</p>
                    </div>
                    ...
                    <div class="group p-7 rounded-2xl border border-slate-100 hover:border-rose-200 hover:shadow-lg hover:shadow-rose-50 transition-all">
                        ...
                        <h3 class="font-semibold text-slate-900 text-lg mb-2">Builder Mudah</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Editor visual intuitif. Ubah foto, warna, font, dan konten secara langsung. Preview langsung tanpa coding.</p>
                    </div>
                    ...
                    <div class="group p-7 rounded-2xl border border-slate-100 hover:border-rose-200 hover:shadow-lg hover:shadow-rose-50 transition-all">
                        ...
                        <h3 class="font-semibold text-slate-900 text-lg mb-2">Amplop Digital</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Tampilkan nomor rekening dan e-wallet dengan elegan. Tamu bisa memberi hadiah langsung dari undangan.</p>
                    </div>

                    {{-- Feature 6 --}}
                    <div class="group p-7 rounded-2xl border border-slate-100 hover:border-rose-200 hover:shadow-lg hover:shadow-rose-50 transition-all">
                        <div class="w-12 h-12 rounded-xl bg-sky-100 flex items-center justify-center mb-5 group-hover:bg-sky-200 transition-colors">
                        ...
                        <h3 class="font-semibold text-slate-900 text-lg mb-2">Google Maps</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Embed peta lokasi akad dan resepsi. Tamu bisa langsung navigasi dengan satu klik dari undangan.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        {{-- ===================== CARA KERJA ===================== --}}
        <section class="py-24 bg-linear-to-br from-rose-50 to-pink-50">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <span class="text-rose-500 text-sm font-semibold uppercase tracking-widest">Prosesnya Simpel</span>
                    <h2 class="font-serif text-4xl font-bold text-slate-900 mt-3">Siap dalam 3 Langkah</h2>
                </div>
        ...
        <section id="tema" class="py-24 bg-white">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <span class="text-rose-500 text-sm font-semibold uppercase tracking-widest">Koleksi Tema</span>
                    <h2 class="font-serif text-4xl font-bold text-slate-900 mt-3">Pilih Tema Impianmu</h2>
                    <p class="text-slate-500 mt-4 max-w-xl mx-auto">Setiap tema dirancang dengan detail yang indah untuk mengabadikan momen spesialmu.</p>
                </div>

                <div class="grid md:grid-cols-3 gap-8">
                    {{-- Theme 1 --}}
                    <div class="group rounded-2xl overflow-hidden border border-slate-100 hover:shadow-xl hover:shadow-rose-100 transition-all duration-300 hover:-translate-y-1">
                        {{-- Replace with real theme preview image --}}
                        <div class="relative overflow-hidden">
                            <img src="https://placehold.co/400x300/fce7f3/9f1239?text=Elegant+Rose" alt="Tema Elegant Rose" class="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-500">
                            <div class="absolute top-3 right-3 px-2.5 py-1 bg-white/90 backdrop-blur-sm rounded-full text-xs font-semibold text-rose-700">Terlaris</div>
                        </div>
                        <div class="p-6">
                            <div class="flex items-center gap-2 mb-1">
                                <span class="w-4 h-4 rounded-full bg-rose-400 inline-block"></span>
                                <span class="w-4 h-4 rounded-full bg-rose-200 inline-block"></span>
                                <span class="w-4 h-4 rounded-full bg-amber-700 inline-block"></span>
                            </div>
                            <h3 class="font-serif text-xl font-semibold text-slate-900 mt-3">Elegant Rose</h3>
                            <p class="text-slate-500 text-sm mt-1 mb-4">Floral romantis dengan nuansa pink rose dan tipografi serif elegan.</p>
                            <div class="flex items-center justify-between">
                                <span class="font-bold text-slate-900">Rp 99.000</span>
                                <a href="{{ route('register') }}" class="text-sm font-medium text-rose-600 hover:text-rose-700">Pilih Tema →</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group rounded-2xl overflow-hidden border border-slate-100 hover:shadow-xl hover:shadow-rose-100 transition-all duration-300 hover:-translate-y-1">
                        <div class="relative overflow-hidden">
                            <img src="https://placehold.co/400x300/f1f5f9/1a1a1a?text=Modern+Minimalist" alt="Tema Modern Minimalist" class="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-500">
                        </div>
                        <div class="p-6">
                            <div class="flex items-center gap-2 mb-1">
                                <span class="w-4 h-4 rounded-full bg-slate-900 inline-block"></span>
                                <span class="w-4 h-4 rounded-full bg-slate-100 border border-slate-200 inline-block"></span>
                                <span class="w-4 h-4 rounded-full bg-amber-400 inline-block"></span>
                            </div>
                            <h3 class="font-serif text-xl font-semibold text-slate-900 mt-3">Modern Minimalist</h3>
                            <p class="text-slate-500 text-sm mt-1 mb-4">Desain bersih dengan white space luas dan tipografi modern sans-serif.</p>
                            <div class="flex items-center justify-between">
                                <span class="font-bold text-slate-900">Rp 119.000</span>
                                <a href="{{ route('register') }}" class="text-sm font-medium text-rose-600 hover:text-rose-700">Pilih Tema →</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group rounded-2xl overflow-hidden border border-slate-100 hover:shadow-xl hover:shadow-rose-100 transition-all duration-300 hover:-translate-y-1">
                        <div class="relative overflow-hidden">
                            <img src="https://placehold.co/400x300/f0fdf4/166534?text=Floral+Garden" alt="Tema Floral Garden" class="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-500">
                        </div>
                        <div class="p-6">
                            <div class="flex items-center gap-2 mb-1">
                                <span class="w-4 h-4 rounded-full bg-green-700 inline-block"></span>
                                <span class="w-4 h-4 rounded-full bg-stone-100 border border-stone-200 inline-block"></span>
                                <span class="w-4 h-4 rounded-full bg-amber-400 inline-block"></span>
                            </div>
                            <h3 class="font-serif text-xl font-semibold text-slate-900 mt-3">Floral Garden</h3>
                            <p class="text-slate-500 text-sm mt-1 mb-4">Tema kebun bunga dengan ilustrasi botanical dan palet hijau alami.</p>
                            <div class="flex items-center justify-between">
                                <span class="font-bold text-slate-900">Rp 109.000</span>
                                <a href="{{ route('register') }}" class="text-sm font-medium text-rose-600 hover:text-rose-700">Pilih Tema →</a>
                            </div>
                        </div>
                    </div>
        ...
        {{-- ===================== HARGA ===================== --}}
        <section id="harga" class="py-24 bg-slate-900">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <span class="text-rose-400 text-sm font-semibold uppercase tracking-widest">Harga Transparan</span>
                    <h2 class="font-serif text-4xl font-bold text-white mt-3">Pilih Paket yang Tepat</h2>
                    <p class="text-slate-400 mt-4">Harga sudah termasuk hosting selama 12 bulan. Bayar sekali, aktif setahun.</p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8 items-stretch">
                    ...
                    <div class="bg-slate-800 rounded-2xl p-8 border border-slate-700 flex flex-col">
                        <div>
                            <p class="text-slate-400 text-sm font-medium">Paket Dasar</p>
                            <p class="font-serif text-4xl font-bold text-white mt-2">Rp 99rb</p>
                            <p class="text-slate-500 text-sm mt-1">mulai dari</p>
                            <hr class="border-slate-700 my-6">
                            <ul class="space-y-3 text-sm text-slate-300">
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> 1 tema pilihan</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Form RSVP gratis</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Animasi dasar (CSS)</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Link aktif 12 bulan</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Notifikasi WhatsApp</li>
                                <li class="flex items-center gap-2 text-slate-500"><span>✕</span> Galeri foto</li>
                                <li class="flex items-center gap-2 text-slate-500"><span>✕</span> Animasi premium (GSAP)</li>
                            </ul>
                        </div>
                        <a href="{{ route('register') }}" class="mt-8 block text-center px-6 py-3 border border-rose-500 text-rose-400 hover:bg-rose-500 hover:text-white font-semibold rounded-full transition-colors">Mulai Sekarang</a>
                    </div>
                    ...
                    <div class="bg-slate-800 rounded-2xl p-8 border border-slate-700 flex flex-col">
                        <div>
                            <p class="text-slate-400 text-sm font-medium">Paket Premium</p>
                            <p class="font-serif text-4xl font-bold text-white mt-2">Rp 259rb</p>
                            <p class="text-slate-500 text-sm mt-1">pengalaman sinematik</p>
                            <hr class="border-slate-700 my-6">
                            <ul class="space-y-3 text-sm text-slate-300">
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> 1 tema pilihan</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Form RSVP + Dashboard</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Animasi Lottie (Premium)</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Link aktif 12 bulan</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Semua addon tersedia</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Amplop digital</li>
                                <li class="flex items-center gap-2"><span class="text-rose-400">✓</span> Live streaming embed</li>
                            </ul>
                        </div>
                        <a href="{{ route('register') }}" class="mt-8 block text-center px-6 py-3 border border-rose-500 text-rose-400 hover:bg-rose-500 hover:text-white font-semibold rounded-full transition-colors">Mulai Sekarang</a>
                    </div>
        ...
        <section class="py-24 bg-rose-50">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-white rounded-2xl p-7 shadow-sm border border-rose-100">
                        <div class="flex gap-1 mb-4">
                            @for($i = 0; $i < 5; $i++)
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-amber-400"><path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clip-rule="evenodd" /></svg>
                            @endfor
                        </div>
                        <p class="text-slate-600 text-sm leading-relaxed mb-5">"Tamu-tamu saya kagum dengan undangannya! Sangat mudah dibuat dan hasilnya jauh lebih cantik dari yang saya bayangkan. RSVP-nya juga sangat membantu."</p>
                        <div class="flex items-center gap-3">
                            {{-- Replace with real avatar --}}
                            <img src="https://placehold.co/40x40/fce7f3/9f1239?text=SA" alt="Sari" class="w-10 h-10 rounded-full object-cover">
                            <div>
                                <p class="font-semibold text-slate-900 text-sm">Sari & Andi</p>
                                <p class="text-slate-400 text-xs">Pernikahan Oktober 2024</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-7 shadow-sm border border-rose-100">
                        ...
                        <p class="text-slate-600 text-sm leading-relaxed mb-5">"Proses dari daftar sampai undangan aktif cuma 30 menit! Notifikasi WhatsApp ke pasangan saya saat ada yang RSVP adalah fitur favorit kami."</p>
                        <div class="flex items-center gap-3">
                            <img src="https://placehold.co/40x40/f0fdf4/166534?text=RB" alt="Rini" class="w-10 h-10 rounded-full object-cover">
                            <div>
                                <p class="font-semibold text-slate-900 text-sm">Rini & Budi</p>
                                <p class="text-slate-400 text-xs">Pernikahan November 2024</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-7 shadow-sm border border-rose-100">
                        ...
                        <p class="text-slate-600 text-sm leading-relaxed mb-5">"Tema Floral Garden-nya persis dengan konsep pernikahan kami. Tamu-tamu sangat terkesan dengan animasi dan tampilannya yang mewah."</p>
                        <div class="flex items-center gap-3">
                            <img src="https://placehold.co/40x40/f1f5f9/1a1a1a?text=DH" alt="Dewi" class="w-10 h-10 rounded-full object-cover">
                            <div>
                                <p class="font-semibold text-slate-900 text-sm">Dewi & Hendra</p>
                                <p class="text-slate-400 text-xs">Pernikahan Desember 2024</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-24 bg-white">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <span class="text-rose-500 text-sm font-semibold uppercase tracking-widest">FAQ</span>
                    <h2 class="font-serif text-4xl font-bold text-slate-900 mt-3">Pertanyaan yang Sering Diajukan</h2>
                </div>

                <div class="space-y-4" id="faq-list">
                    @foreach([
                        ['q' => 'Apakah undangan bisa diakses dari WhatsApp?', 'a' => 'Ya! Undangan dibuka sempurna di browser WhatsApp. Kami telah mengoptimalkan semua tema untuk browser in-app WhatsApp di Android dan iOS, termasuk fallback untuk autoplay musik.'],
                        ['q' => 'Berapa lama undangan aktif?', 'a' => 'Undangan aktif selama 12 bulan dari tanggal aktivasi. Setelah masa aktif berakhir, link tidak lagi dapat diakses oleh tamu.'],
                        ['q' => 'Bisakah saya mengubah konten setelah dibayar?', 'a' => 'Ya, kamu bisa mengubah konten (teks, foto, warna) kapan saja sebelum dan setelah aktivasi melalui builder. Perubahan langsung tampil di undangan.'],
                        ['q' => 'Metode pembayaran apa yang tersedia?', 'a' => 'Kami menerima semua metode pembayaran melalui Midtrans: transfer bank (BCA, Mandiri, BNI, BRI), GoPay, OVO, Dana, QRIS, dan kartu kredit/debit.'],
                        ['q' => 'Apakah ada biaya tambahan untuk addon?', 'a' => 'Addon seperti galeri foto, musik, Google Maps, dan amplop digital bisa ditambahkan secara terpisah dengan harga mulai Rp 19.000 per addon.'],
                    ] as $faq)
                    <div class="faq-item border border-slate-200 rounded-xl overflow-hidden">
                        <button class="faq-toggle w-full text-left px-6 py-4 flex items-center justify-between font-medium text-slate-800 hover:bg-rose-50 transition-colors">
                            <span>{{ $faq['q'] }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="faq-icon w-5 h-5 text-rose-500 shrink-0 transition-transform duration-200">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                            </svg>
                        </button>
                        <div class="faq-answer hidden px-6 pb-4 text-slate-500 text-sm leading-relaxed">
                            {{ $faq['a'] }}
                        </div>
                    </div>
                    @endforeach
        ...
        {{-- ===================== KONTAK ===================== --}}
        <section id="kontak" class="py-24 bg-linear-to-br from-rose-50 to-pink-50">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-16 items-start">
                    {{-- Info --}}
                    <div>
                        <span class="text-rose-500 text-sm font-semibold uppercase tracking-widest">Hubungi Kami</span>
                        <h2 class="font-serif text-4xl font-bold text-slate-900 mt-3 mb-6">Ada Pertanyaan?<br>Kami Siap Membantu</h2>
                        <p class="text-slate-500 leading-relaxed mb-8">Tim kami siap membantu kamu dari proses pemilihan tema hingga undangan aktif. Hubungi kami via WhatsApp untuk respons paling cepat.</p>
                        ...
                        <div class="space-y-5">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://wa.me/628123456789" target="_blank" class="text-rose-600 hover:underline text-sm">+62 812-3456-789</a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-500 text-sm">Senin–Sabtu, 09.00–21.00 WIB</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-rose-100 p-8">
                        <h3 class="font-serif text-2xl font-semibold text-slate-900 mb-6">Kirim Pesan</h3>
                        <form action="https://wa.me/628123456789" method="get" target="_blank" class="space-y-5">
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1.5">Nama Lengkap</label>
                                <input type="text" name="nama" placeholder="Sari Wulandari" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-rose-300 focus:border-transparent transition-shadow">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1.5">Nomor WhatsApp</label>
                                <input type="tel" name="wa" placeholder="0812-xxxx-xxxx" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-rose-300 focus:border-transparent transition-shadow">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1.5">Tanggal Pernikahan</label>
                                <input type="date" name="tanggal" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-rose-300 focus:border-transparent transition-shadow">
                            </div>
                            <div>
        ...
        <section class="py-20 bg-rose-600 relative overflow-hidden">
            <div class="absolute inset-0 opacity-10">
                <div class="absolute top-0 left-1/4 w-64 h-64 bg-white rounded-full -translate-y-1/2"></div>
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="flex gap-4 mt-5">
                            {{-- Instagram --}}
                            <a href="#" class="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center hover:bg-rose-600 transition-colors">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#tema" class="hover:text-rose-400 transition-colors">Tema Undangan</a></li>
                            <li><a href="#fitur" class="hover:text-rose-400 transition-colors">Fitur Lengkap</a></li>
                            <li><a href="#harga" class="hover:text-rose-400 transition-colors">Harga & Paket</a></li>
                            <li><a href="{{ route('register') }}" class="hover:text-rose-400 transition-colors">Buat Undangan</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#faq-list" class="hover:text-rose-400 transition-colors">FAQ</a></li>
                            <li><a href="#kontak" class="hover:text-rose-400 transition-colors">Kontak Kami</a></li>
                            <li><a href="{{ route('login') }}" class="hover:text-rose-400 transition-colors">Masuk</a></li>
                            <li><a href="{{ route('register') }}" class="hover:text-rose-400 transition-colors">Daftar</a></li>
                        </ul>
                    </div>
                </div>
