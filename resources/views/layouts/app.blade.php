...
<body class="bg-base-200 antialiased min-h-screen">
    ...
    <div class="navbar bg-base-100 border-b border-base-300 shadow-sm sticky top-0 z-40">
        <div class="navbar-start">
            <a href="{{ route('home') }}" class="flex items-center gap-2 px-2">
                ...
                <span class="font-bold text-lg text-base-content">{{ config('app.name') }}</span>
            </a>
        </div>
        ...
        <div class="navbar-end gap-1">
            ...
            @else
                ...
                <a href="{{ route('register') }}" class="btn btn-accent btn-sm font-semibold">Daftar Gratis</a>
            @endauth
        </div>
    </div>
